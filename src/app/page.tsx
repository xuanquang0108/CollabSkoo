      ...
      <section className={homeStyles.homepage}>
          ...
          <section className={homeStyles.heroImage}>
              <div className={homeStyles.heroContent}>
                  <h1>Chào mừng đến với <span className={homeStyles.brand}><br/><strong>CollabSkoo</strong></span></h1>
          ...
          <section className={`${homeStyles.cta} ${homeStyles.dark}`}>
              <div className={homeStyles.ctaContent}>
                  ...
                  <p><strong>Share the wealth of knowledge</strong> — mỗi tài liệu bạn đăng là một cánh cửa mở ra cho
                      người khác.</p>
                  <a href="/upload" className={homeStyles.btn}>Đóng góp tài liệu</a>
              </div>
          </section>

          {/*CATEGORIES SECTION*/}
          <section className={categoriesStyles.categoriesContainer}>
              <CategoriesDisplay categories={categories ?? []}></CategoriesDisplay>
          </section>
